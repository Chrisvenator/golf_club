        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="login100-form validate-form" action="#" method="post">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="./insert_golffeld.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                        create Golffeld
...
//    echo "Golfplatz inserted";
    $name = $_POST['name'];
    $addresse = $_POST['addresse'];
    $eigentuemer = $_POST['eigentuemer'];

    $Golfplatz = new Golfplatz();
    $Golfplatz->setName($name);
    $Golfplatz->setAddresse($addresse);
    $Golfplatz->setEigentuemer($eigentuemer);

    $entityManager->persist($Golfplatz);
    $entityManager->flush();
